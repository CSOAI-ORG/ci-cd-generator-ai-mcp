...
@mcp.tool()
def generate_github_actions(language: str, test_command: str = '') -> str:
    """MEOK AI Labs tool."""
...
@mcp.tool()
def generate_gitlab_ci(language: str) -> str:
    """MEOK AI Labs tool."""
    if err := _rl(): return err
...
@mcp.tool()
def generate_jenkinsfile(language: str, stages: str = 'build,test,deploy') -> str:
    """MEOK AI Labs tool."""
    if err := _rl(): return err
...
@mcp.tool()
def lint_workflow(workflow_yaml: str) -> str:
    """MEOK AI Labs tool."""
    if err := _rl(): return err
